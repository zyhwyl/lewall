...
public class FrameAct {
	...
	@RequestMapping("/frame/school_main.do")
	public String schoolMain(ModelMap model) {
		return "frame/school_main";
	}
	
	@RequestMapping("/frame/school_left.do")
	public String schoolLeft(){
		return "frame/school_left";
	}
	
	@RequestMapping("/frame/school_right.do")
	public String schoolRight(){
		return "frame/school_right";
	}
}
