...
public class FrontContextInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (user != null) {  
			if(checkMng.isCheckinToday(user.getId())){
				user.setIsCheckinToday(1);
			}else{
				user.setIsCheckinToday(0);
			}
	...
	private AcUserCheckinMng checkMng;

	@Autowired
	public void setCheckin(AcUserCheckinMng checkMng) {
		this.checkMng = checkMng;
	}
