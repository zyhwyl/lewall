...
public interface CmsUserMng {
	...
	public CmsUser registerMember(String username, String email,
			String password, String ip, Integer groupId, CmsUserExt userExt, Boolean activation , EmailSender sender)throws UnsupportedEncodingException, MessagingException ;
	
	public CmsUser registerQQMember(String username, String email,String openid,
			String ip, Integer groupId, CmsUserExt userExt, Boolean activation , EmailSender sender)throws UnsupportedEncodingException, MessagingException ;
	...
	public List<CmsUser> findUserBySchool(String []keys,Object []values,Integer count);
}