 ...
 * 
 */
public interface ActivityCommentMng {
	...
	public List<ActivityComment> getListByProperities(String []keys,Object []values);
	public List<ActivityComment> getListByProperities(String []keys,Object []values,String order);
}