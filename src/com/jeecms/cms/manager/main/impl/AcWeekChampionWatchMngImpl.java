...
import com.jeecms.cms.manager.main.AcWeekChampionWatchMng;
...
@Service
@Transactional
public class AcWeekChampionWatchMngImpl implements AcWeekChampionWatchMng {

	private AcWeekChampionWatchDao dao;

	@Autowired
	public void setDao(AcWeekChampionWatchDao dao) {
		this.dao = dao;
	}
