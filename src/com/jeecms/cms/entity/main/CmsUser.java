...
public class CmsUser extends BaseCmsUser implements PriorityInterface {
	...
	private Integer isCheckinToday; 
	 
	public String getUserSay() {
		String userSay=this.getUserSignature();
		if(userSay!=null){
			userSay=StrUtils.convertExpresiion(userSay,"");
		} 
		return userSay;
	} 
	
	public Integer getIsCheckinToday() {
		return isCheckinToday;
	}

	public void setIsCheckinToday(Integer isCheckinToday) {
	...
	public String getUserImg() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
			return ext.getUserImg().replace("origin","");
		} else {
			return null;
		}
	}
	public String getUserThumbImg() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
			return ext.getUserImg().replace("origin","thumb");
		} else {
			return null;
		}
	}
	public String getUserCircleImg() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
			return ext.getUserImg().replace("origin","circle");
		} else {
			return null;
		}
	}
	public String getUserCornerImg() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
			return ext.getUserImg().replace("origin","corner");
		} else {
			return null;
		}
	}
	public String getUserOriImg() {
		CmsUserExt ext = getUserExt();
		if (ext != null) {
	...
	public CmsUser(java.lang.Integer id,
			...
			java.lang.Boolean disabled,Integer schoolId) {
