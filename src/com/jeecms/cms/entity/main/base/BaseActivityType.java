...
/**
 * This is an object that contains data related to the activity_type table.
...
public abstract class BaseActivityType  implements Serializable {

	public static String REF = "ActivityType";
	 ...
	 */
	public BaseActivityType (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.jeecms.cms.entity.main.ActivityType)) return false;
		else {
			com.jeecms.cms.entity.main.ActivityType activityType = (com.jeecms.cms.entity.main.ActivityType) obj;
			if (null == this.getId() || null == activityType.getId()) return false;
			else return (this.getId().equals(activityType.getId()));
		}
	}
