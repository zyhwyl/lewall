...
public abstract class BaseCmsUser  implements Serializable {
	...
	private Integer teamsendFlag;
	private Integer addfriendFlag;
	...
	public Integer getAddfriendFlag() {
		return addfriendFlag;
	}

	public void setAddfriendFlag(Integer addfriendFlag) {
		this.addfriendFlag = addfriendFlag;
	}

	public Integer getTeamsendFlag() {
		return teamsendFlag;
	}

	public void setTeamsendFlag(Integer teamsendFlag) {
		this.teamsendFlag = teamsendFlag;
	}
