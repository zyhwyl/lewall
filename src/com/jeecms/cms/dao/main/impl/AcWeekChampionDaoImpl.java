...
@Repository
public class AcWeekChampionDaoImpl extends HibernateBaseDao<AcWeekChampion, Integer>
		implements AcWeekChampionDao {
	...
	public AcWeekChampion deleteById(Integer id) {
		AcWeekChampion entity=super.get(id);
		if (entity != null) {
	...
	@Override
	protected Class<AcWeekChampion> getEntityClass() {
		return AcWeekChampion.class;
	}

	@Override
	public Pagination getPaginationByProperities(String[] keys,
			Object[] values, int pageNo, int pageSize) {
		Finder f = Finder.create("from AcWeekChampion bean");
		f.append(" where ");
	...
	public AcWeekChampion findById(Integer id) {
		return (AcWeekChampion)getSession().get(AcWeekChampion.class, id);
	}
